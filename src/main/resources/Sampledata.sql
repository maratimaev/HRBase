...
INSERT INTO organization (name, full_name, inn, kpp, address, phone, is_active, version) VALUES (
    'ООО «Пример»',
...
INSERT INTO office (org_id, name, address, phone, is_active, version) VALUES (
    1,
    'Светлый',
    '124365 г.Москва, ул. Ленина, д.1, корп.1, офис 1',
    '+7 495 233 4456',
...
INSERT INTO employer (office_id, first_name, last_name, position, phone, document_id, citizenship_id, is_identified, version) VALUES (
    1, 'Иван', 'Иванов', 'стажер', '+7 917 345 4554', '1', '1', TRUE, 0
);
INSERT INTO employer (office_id, first_name, last_name, position, phone, document_id, citizenship_id, is_identified, version) VALUES (
    1, 'Петр', 'Сидоров', 'инженер', '+7 917 453 4554', '2', '3', TRUE, 0
);
INSERT INTO employer (office_id, first_name, last_name, position, phone, document_id, citizenship_id, is_identified, version) VALUES (
    2, 'Константин', 'Котов', 'специалист', '+7 917 432 6678', '3', '1', FALSE, 0
);
INSERT INTO employer (office_id, first_name, last_name, position, phone, document_id, citizenship_id, is_identified, version) VALUES (
    3, 'Максим', 'Петров', 'руководитель', '+7 917 535 4534', '4', '5', TRUE, 0
);
INSERT INTO employer (office_id, first_name, last_name, position, phone, document_id, citizenship_id, is_identified, version) VALUES (
    3, 'Вячеслав', 'Архипов', 'водитель', '+7 917 321 2331', '5', '2', FALSE, 0
);